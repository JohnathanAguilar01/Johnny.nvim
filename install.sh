...
echo
echo "[2/6] Installing Neovim build dependencies..."
...
echo
echo "[3/6] Installing Neovim plugin dependencies..."
sudo apt-get install -y \
    python3-venv \
    nodejs \
    npm
...
echo
echo "[4/6] Installing Neovim v0.12.0..."
...
echo
echo "[5/6] Removing Neovim source files..."

cd "$HOME"
rm -rf "$HOME/neovim"

echo
echo "[6/6] Installing Johnny.nvim configuration..."
